...
The app is designed to run locally on Windows, use a local Ollama model, and keep all inference on the machine. The current default model is `gemma4:e4b`.
...
- `Model: gemma4:e4b via python_ollama`
- `Model: gemma4:e4b via windows_ollama_bridge`
